      ...
      <section className="container mx-auto px-4 py-10 max-w-6xl space-y-6">
        <div className="bento-card rounded-3xl p-6 flex flex-wrap items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="font-mono text-xs text-muted-foreground tracking-wide mt-0.5">Manage students and premium access.</p>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="bento-card rounded-2xl p-5 flex items-center gap-4">
            <span className="w-12 h-12 rounded-xl bg-accent flex items-center justify-center">
              <Users className="w-5 h-5 text-secondary" />
            </span>
            <div>
              <p className="font-mono text-[11px] text-muted-foreground tracking-wider uppercase">Total students</p>
              <p className="text-3xl font-bold font-serif">{students.length}</p>
            </div>
          </div>
          <div className="bento-card rounded-2xl p-5 flex items-center gap-4">
            <span className="w-12 h-12 rounded-xl bg-[#C07850]/10 flex items-center justify-center">
              <Crown className="w-5 h-5 text-[#C07850]" />
            </span>
            <div>
              <p className="font-mono text-[11px] text-muted-foreground tracking-wider uppercase">Premium students</p>
              <p className="text-3xl font-bold font-serif">{premiumCount}</p>
            </div>
          </div>
        </div>
