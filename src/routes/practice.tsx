    ...
    <SiteLayout>
      <section className="container mx-auto px-4 py-16 max-w-5xl relative">
        ...
        <div className="relative text-center mb-16">
          ...
          <p className="relative text-base text-[#9A9A9A] font-sans">
            Pick a skill and start — every section is built around real IELTS question types.
          </p>

          {/* Block row */}
          <div className="flex justify-center gap-2 mt-4">
            {["#5D8A3C","#6AAFE6","#FFD700","#C0392B"].map((c, i) => (
              <div
                key={i}
          ...
          {SECTIONS.map((s) => (
            <Link key={s.to} to={s.to} className="block">
              ...
              >
                ...
                <p className="text-sm text-[#9A9A9A] mb-4 flex-1 leading-relaxed font-sans">{s.desc}</p>
