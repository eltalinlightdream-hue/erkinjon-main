      ...
      <section className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="relative mb-6 max-w-md">
          ...
          <Input
            ...
            className="pl-9 font-mono text-sm h-11 rounded-xl border-border/60 focus:border-primary bg-background"
          />
        </div>

        {/* Topic filter row */}
        <div className="mb-3">
          <p className="font-mono text-[10px] tracking-widest uppercase text-muted-foreground/70 mb-2">Topic</p>
        ...
        <div className="mb-8">
          <p className="font-mono text-[10px] tracking-widest uppercase text-muted-foreground/70 mb-2">Difficulty</p>
          <div className="flex flex-wrap gap-2">
