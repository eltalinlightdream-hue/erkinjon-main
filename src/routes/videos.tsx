      ...
      <section className="container mx-auto px-4 py-12 max-w-6xl">
        <div className="flex flex-wrap items-end justify-between gap-4 mb-10">
          ...
          <a href={CHANNEL_URL} target="_blank" rel="noreferrer">
            <Button className="bg-[#FF0000] hover:bg-[#FF0000]/90 text-white font-mono text-xs tracking-wide active:scale-95 transition-all">
              <Youtube className="w-4 h-4 mr-2" /> Visit Full Channel
            </Button>
          </a>
        </div>
              ...
              <div key={pl.id}>
                <div className="flex items-baseline justify-between gap-4 mb-5">
                  <div>
                    ...
                    {pl.description && <p className="text-sm text-muted-foreground line-clamp-2 max-w-2xl mt-1">{pl.description}</p>}
                  </div>
                  <span className="font-mono text-[11px] text-muted-foreground whitespace-nowrap tracking-wider">{pl.videos.length} videos</span>
                </div>
