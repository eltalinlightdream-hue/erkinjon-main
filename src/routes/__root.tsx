...
import { CursorGlowBackground } from "@/components/cursor-glow-background";
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('theme');document.documentElement.classList.add(t==='dark'?'dark':'light');}catch(e){}})();`,
          }}
        />
      </head>
      <body>
