...
export const Route = createFileRoute("/writing_/sample/$id")({
  head: ({ params }) => {
    ...
    return {
      meta: [
        { title: s ? `Report ${s.reportNumber} — ${s.chartType} | Abduraimov Erkinjon` : "Sample not found" },
    ...
    return (
      <SiteLayout>
        <div className="container mx-auto px-4 py-24 text-center">
          ...
          <Link to="/writing" className="font-mono text-xs tracking-wider text-secondary hover:underline">
            ← Back to writing
          </Link>
        </div>
      </SiteLayout>
    ...
    <SiteLayout>
      <div className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <div
          ...
          ref={contentRef}
          className={cn(
            "prose prose-neutral dark:prose-invert max-w-none mb-12",
